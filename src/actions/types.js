...
export const REQUEST_BRAND_MODELS = 'SAGA/REQUEST_BRAND_MODELS';
export const REQUEST_NEW_VEHICLES = 'SAGA/REQUEST_NEW_VEHICLES';
export const REQUESTNEW_VEHICLE = 'SAGA/REQUEST_NEW_VEHICLE';
...
// Types for action creators of API requests
export const FETCH_DEALERS = 'FETCH_DEALERS';
export const FETCH_BRANDS = 'FETCH_BRANDS';
export const FETCH_MODELS = 'FETCH_MODELS';
export const FETCH_BRAND_MODELS = 'FETCH_BRAND_MODELS';
export const FETCH_NEW_VEHICLES = 'FETCH_NEW_VEHICLES';
export const FETCH_NEW_VEHICLE = 'FETCH_NEW_VEHICLE';
export const FETCH_TRADEIN_VEHICLES = 'FETCH_TRADEIN_VEHICLES';
export const FETCH_TRADEIN_VEHICLE = 'FETCH_TRADEIN_VEHICLE';
export const FETCH_ALL_NEW_VEHICLES = 'FETCH_ALL_NEW_VEHICLES';
